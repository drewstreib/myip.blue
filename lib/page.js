...
<ul>
<li>If <span class="code">user-agent</span> begins with '<span class="code">curl</span>' or '<span class="code">wget</span>' at <span class="code">/</span>, the behavior also defaults to the simple text string. For more detailed information while using curl, use the <span class="code"><a href="https://myip.blue/json">/json</a></span> endpoint.</li>
</ul>
