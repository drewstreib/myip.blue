...
<ul>
<li>At <span class="code">/</span>, JSON is the default. An <span class="code">Accept:</span> header naming a type wins; failing that, a user-agent starting with <span class="code">Mozilla/</span> gets this page.</li>
</ul>
