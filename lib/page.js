...
<li><span class="code"><a href="https://myip.blue/html">myip.blue/html</a></span> forces this page, whatever your client asked for.</li>
<ul>
<li>At <span class="code">/</span>, anything that doesn't look like a browser gets <span class="code"><a href="https://myip.blue/json">/json</a></span> — so <span class="code">curl myip.blue</span> returns JSON. Send <span class="code">Accept: text/plain</span>, or use <span class="code"><a href="https://myip.blue/ip">/ip</a></span>, for just the address.</li>
</ul>
